...
--
-- Host: 127.0.0.1
-- Generation Time: 07-Jul-2022 às 04:29
...
(5, 'Lógica de programação', '1', 'Lógica de programação para o dia a dia', 'Lógica', 1, 1),
...
--
ALTER TABLE `trilha`
  MODIFY `trilha_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `trilha_videos`
  MODIFY `trilha_videos_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
