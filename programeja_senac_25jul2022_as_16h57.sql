...
--
-- Host: 127.0.0.1
-- Generation Time: 25-Jul-2022 às 21:56
...
INSERT INTO `user` (`user_id`, `user_name`, `user_email`, `user_access_type`, `user_whatsapp`, `user_logradouro`, `user_numero`, `user_complemento`, `user_cep`, `user_bairro`, `user_cidade`, `user_uf`, `user_cpf`, `user_idade`, `user_login`, `user_password`, `user_pix`, `user_photo`, `user_date`) VALUES
...
(2, 'Giberto Pereira Santos', 'gilbertosantos@xpto.com', 0, '', '', '', '', '88085888', '', '', '', '', '', '', '123456', '', 'https://userstock.io/data/wp-content/uploads/2020/06/tyler-nix-PQeoQdkU9jQ-1024x1024.jpg', ''),
...
(13, 'Julia Cristina Carvalho', 'juliacristinaxpto@xpto.com', 0, '44949499499', 'rua das acácias', '12', 'fundos', '88888888', 'Centro', 'Florianópolis', 'SC', '55555555555', '30', '', '', 'julia@sdfdsfdsa', 'https://userstock.io/data/wp-content/uploads/2017/09/michael-dam-258165-300x300.jpg', ''),
(28, 'Mauro Gonçalves Oliveira', 'mauro@xpto.com', 0, '48988026426', 'Rua das Casas', '15', '', '88085260', 'Centro', 'Florianópolis', 'SC', '55853676920', '26', 'mauro@xpto.com', '', 'mauro@dfsfsdf', 'images/users/avatar.png', ''),
(29, 'Adriele Santos', 'nana@xpto.com', 0, '48488999999', 'Rua das Casas', '15', 'funcods', '88888888', 'Centro', 'São José', 'SC', '99999999999', '30', 'nana@xpto.com', 'e10adc3949ba59abbe56e057f20f883e', 'nana@dfddfsd', 'images/users/avatar.png', ''),
(30, 'Marcelo Neri da Silva', 'marceloneri@gmail.com', 0, '48488999999', 'Rua Fernando Ferreira de Mello', '234', 'bloco B apto 201', '88085260', 'Bom Abrigo', 'Florianópolis', 'SC', '55853676920', '58', 'marceloneri@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'marcelo@dfdfsdsdf', 'images/users/foto_marcelo.jpg', '');
...
--
ALTER TABLE `conteudo`
  MODIFY `id_conteudo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
--
-- AUTO_INCREMENT for table `conteudo_indice`
--
ALTER TABLE `conteudo_indice`
  MODIFY `id_conteudo_indice` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
--
...
--
ALTER TABLE `trilha_videos`
  MODIFY `trilha_videos_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
--
...
--
ALTER TABLE `user_trilha`
  MODIFY `usertrilha_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
