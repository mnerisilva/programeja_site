$.ajax({
    ...
    for (userItem of data){
        ...
        _td3.innerHTML = `<i class="fa-solid fa-gear user-course-manager" data-bs-toggle="modal" data-bs-target="#exampleModal"></i>&nbsp;<i class="fa-solid fa-user-gear user-manager"></i>`;
