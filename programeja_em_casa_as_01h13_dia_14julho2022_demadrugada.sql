...
--
-- Host: 127.0.0.1
-- Generation Time: 14-Jul-2022 às 06:12
...
(2, 'Css básico nível 1', 0, 'Aula introdutório css.', 'Css básico nível 1', 1, 1),
...
(9, 'Html nível básico trilha 2', 1, 'Fase 2 dos fundamentos de html', 'Html 2', 2, 1);
...
--
ALTER TABLE `trilha_videos`
  MODIFY `trilha_videos_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
