...
--
-- Host: 127.0.0.1
-- Generation Time: 19-Jul-2022 às 05:28
...
INSERT INTO `user` (`user_id`, `user_name`, `user_email`, `user_logradouro`, `user_numero`, `user_complemento`, `user_cep`, `user_bairro`, `user_cidade`, `user_uf`, `user_login`, `user_password`, `user_photo`, `user_date`) VALUES
